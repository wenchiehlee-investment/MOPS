...
```bash
python ../skills/common/skill-mops-fetch/scripts/run_mops_fetch.py 2330 2024 all --only-missing-files
```

**Download specific quarter and create Markdown sidecars**:
```bash
python ../skills/common/skill-mops-fetch/scripts/run_mops_fetch.py 8272 2023 2 --only-missing-files
```

**PDF-to-Markdown conversion** is handled by `skill-mac-mini-ocr` through `skill-mops-fetch`. Legacy `scripts/pdf_to_md.py` and `scripts/batch_convert.py` are compatibility wrappers only.
...
```bash
python ../skills/common/skill-mops-fetch/scripts/run_mops_fetch.py 8272 2024 all --only-missing-files
```
...
```bash
python ../skills/common/skill-mops-fetch/scripts/run_mops_fetch.py 2382 2023 all --only-missing-files
```
...
### Debug Mode
```bash
python ../skills/common/skill-mops-fetch/scripts/run_mops_fetch.py 2330 2024 all --only-missing-files --log-level DEBUG
```
...
│   └── web/                  # Web navigation
├── scripts/
│   ├── mops_downloader.py    # Deprecated wrapper; use skill-mops-fetch
