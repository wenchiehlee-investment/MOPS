...
The maintained path is skill-mops-fetch, which downloads MOPS
...
def _find_skill_runner(repo: Path) -> Path:
    ...
    for candidate in candidates:
        if candidate.is_file():
            return candidate
    raise SystemExit("Cannot find skill-mops-fetch runner. Expected ../skills/common/skill-mops-fetch/.")
...
def main() -> int:
    ...
    print("DEPRECATED: scripts/batch_convert.py is retired. Delegating to skill-mops-fetch.", file=sys.stderr)
