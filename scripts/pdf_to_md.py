...
Use ../skills/common/skill-mops-fetch/scripts/run_mops_fetch.py
...
def main() -> int:
    ...
    print("DEPRECATED: scripts/pdf_to_md.py is retired. Delegating to skill-mops-fetch.", file=sys.stderr)
