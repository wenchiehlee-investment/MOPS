...
- `python ../skills/common/skill-mops-fetch/scripts/run_mops_fetch.py --help`: quick skill runner sanity check.
- `python ../skills/common/skill-mops-fetch/scripts/run_mops_fetch.py 2382 2025 all --only-missing-files`: single-company download plus Markdown conversion.
...
- `scripts/pdf_to_md.py` and `scripts/batch_convert.py` are compatibility wrappers only. Do not add new conversion logic there; extend `skill-mops-fetch` or `skill-mac-mini-ocr`.
