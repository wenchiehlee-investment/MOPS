...
.
├── .gitignore
├── DownloadAll.py    <--- Batch all stocks via skill-mops-fetch
...
python ../skills/common/skill-mops-fetch/scripts/run_mops_fetch.py 8272 2023 2 --log-level DEBUG --only-missing-files
